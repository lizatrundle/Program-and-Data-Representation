...
string nonPointers[6][5] = {
	...
	string pointers[3][4] = {
		{"int*", "8",  "0xffffffffffffffff" /*max value*/, "0x0000000000000000" /*NULL as stored in hex*/},
		{"char*",  "8",  "0xffffffffffffffff" /*max value*/,"0x0000000000000000"/*NULL as stored in hex*/},
		{"double*",  "8",  "0xffffffffffffffff"  /*max value*/, "0x0000000000000000" /*NULL as stored in hex*/},
	};
