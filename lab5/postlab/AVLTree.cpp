...
// AVL tree: keep the tree balanced after every insert...
//essentially the same as a BST just includes balance factors 
AVLTree::AVLTree() {
    root = NULL;
}
...
// took to get there.
// public path to method 
string AVLTree::pathTo(const string& x) const {
  // if the value isnt in the tree, return empty string
if (!find(x)){
    return "";
    }
